========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта основы ООП(площади фигур)
========================================================================

Это приложение основы ООП(площади фигур) создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения основы ООП(площади фигур).


основы ООП(площади фигур).vcxproj
...
основы ООП(площади фигур).vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем основы ООП(площади фигур).pch и файла предкомпилированных типов с именем StdAfx.obj.
